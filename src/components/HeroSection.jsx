	...
	return (
		<section id="hero" className="min-h-screen border-b border-white flex items-center justify-center bg-gradient-to-b from-gray-800 via-gray-700 to-gray-900 text-white">
			<div className="text-center flex flex-col gap-3">
				...
				<Link to="about" smooth={true} offset={-56} duration={500} className="bg-white mx-auto text-gray-900 px-6 py-2 rounded-full hover:scale-95 duration-200 cursor-pointer">
					Learn More
				</Link>
			</div>
		</section>
